...
// Format a currency amount with optional locale and fraction digits.
...
/**
 * Format an ISO date string with optional custom format and same-year shorthand.
 */
...
/**
 * Get up to two initials from a name-like string.
 */
