<script lang="ts">
	...
	import { BadgeCheck, GitCommitHorizontal, GitFork, GitPullRequest, MessageSquareText } from "@lucide/svelte";
...
<section class="github-panel" aria-label="GitHub contributions and recent activity">
...
<style>
	.github-panel {
		display: grid;
		grid-template-columns: minmax(0, 1.8fr) minmax(15rem, 0.9fr);
		min-height: 11rem;
		margin-top: 0.75rem;
		overflow: hidden;
	...
	.contributions,
	.recent { min-width: 0; padding: 1rem; }
	.recent { border-left: 1px solid var(--color-divider); }
	...
	@media (max-width: 760px) {
		...
		.recent { border-top: 1px solid var(--color-divider); border-left: 0; }
	}
</style>
