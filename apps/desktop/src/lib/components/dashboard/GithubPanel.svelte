...
<style>
	...
	.github-message { display: flex; grid-column: 1 / -1; align-items: center; justify-content: center; gap: 0.55rem; padding: 0.75rem; color: var(--color-muted-foreground); font-size: 0.75rem; }
	.github-message div { display: flex; flex-direction: column; gap: 0.2rem; }
	.github-message strong { color: var(--color-foreground); }
	.contributions,
	.recent,
	.notifications { min-width: 0; padding: 0.75rem; }
	...
	.contributions > p { margin: 0.45rem 0 0.55rem; color: var(--color-muted-foreground); font-size: 0.65rem; }
	...
	.activity { display: grid; grid-template-columns: 1.65rem minmax(0, 1fr); gap: 0.45rem; padding: 0.4rem 0; border: 0; border-top: 1px solid var(--color-divider); background: transparent; color: inherit; cursor: pointer; text-align: left; }
