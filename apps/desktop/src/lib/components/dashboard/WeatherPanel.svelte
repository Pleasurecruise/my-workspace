...
<style>
	.context-panel { display: grid; min-width: 0; margin-top: 0.5rem; }
	article,
	.weather-message { min-width: 0; padding: 0.75rem; border: 1px solid var(--color-border); border-radius: var(--radius-lg); background: var(--color-background); box-shadow: var(--shadow-xs); }
	...
	.local-context { justify-content: space-between; gap: 0.75rem; margin-top: 0.5rem; }
	...
	.forecast { display: grid; grid-template-columns: repeat(6, minmax(0, 1fr)); gap: 0.15rem; margin-top: 0.55rem; padding-top: 0.5rem; border-top: 1px solid var(--color-divider); }
