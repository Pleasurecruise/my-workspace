...
<style>
	.stocks-panel { width: 100%; min-width: 0; box-sizing: border-box; padding: 0.75rem; border: 1px solid var(--color-border); border-radius: var(--radius-lg); background: var(--color-background); box-shadow: var(--shadow-xs); }
	header,
	header span,
	.quote,
	...
	.stock-heading { display: grid; min-width: 0; gap: 0.08rem; margin-top: 0.5rem; }
	...
	.chart svg { display: block; width: 100%; height: 2.25rem; overflow: visible; }
