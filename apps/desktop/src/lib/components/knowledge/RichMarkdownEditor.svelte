...
<style>
	...
	.surface :global(.tiptap h1), .surface :global(.tiptap h2), .surface :global(.tiptap h3) { margin: 1.5em 0 0.6em; }
	.surface :global(.tiptap h2) { padding-bottom: 0.25em; border-bottom: 1px solid var(--color-border); }
